...
var StarControl = $hxClasses["StarControl"] = function() { }
...
var star_control = star_control || {}
star_control.Ship = $hxClasses["star_control.Ship"] = function(scene,highlight,imagePath,shipUi,maxHealth,maxAmmo,rechargeRate,fireRate,primaryAmmoCost,turnRate,thrustAccel,maxThrust) {
	titanium_reindeer.GameObject.call(this,scene);
	this.sprite = new titanium_reindeer.ImageRenderer(this.getManager().getImage(imagePath),2);
	...
	this.collision.registerCallback(this.collide.$bind(this));
	...
	this.hitSounds = new titanium_reindeer.SoundGroup(this.getManager().soundManager);
	this.hitSounds.addSound("hit1",this.getManager().getSound("sound/ship_hit.mp3"));
	this.hitSounds.addSound("hit2",this.getManager().getSound("sound/ship_hit.mp3"));
	this.shipUi = shipUi;
...
star_control.Ship.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	sprite: null
	...
	,turn: function(direction,msTimeStep) {
	...
	,attemptShoot: function(msTimeStep) {
	...
	,shoot: function(msTimeStep) {
	}
	,startShooting: function() {
	}
	,shooting: function(msTimeStep) {
	}
	...
	,__class__: star_control.Ship
});
star_control.Artillery = $hxClasses["star_control.Artillery"] = function(scene,highlight,shipUi) {
	star_control.Ship.call(this,scene,highlight,"artillery.png",shipUi,14,16,300,500,8,Math.PI / 2,100,150);
	this.fireSound = this.getManager().getSound("sound/artillery_fire.mp3");
};
star_control.Artillery.__name__ = ["star_control","Artillery"];
star_control.Artillery.__super__ = star_control.Ship;
star_control.Artillery.prototype = $extend(star_control.Ship.prototype,{
	fireSound: null
	,shoot: function(msTimeStep) {
	...
	,__class__: star_control.Artillery
});
star_control.Projectile = $hxClasses["star_control.Projectile"] = function(owner,sprite,speed,damage,msLifeTime) {
...
star_control.Projectile.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	sprite: null
	,collision: null
	,velocity: null
	,owner: null
	...
	,__class__: star_control.Projectile
});
star_control.ArtilleryShell = $hxClasses["star_control.ArtilleryShell"] = function(owner) {
...
star_control.ArtilleryShell.prototype = $extend(star_control.Projectile.prototype,{
	__class__: star_control.ArtilleryShell
});
...
star_control.StarControlScene = $hxClasses["star_control.StarControlScene"] = function(game,name,renderDepth,layerCount,backgroundColor) {
	titanium_reindeer.Scene.call(this,game,name,renderDepth,layerCount,backgroundColor);
};
star_control.StarControlScene.__name__ = ["star_control","StarControlScene"];
star_control.StarControlScene.__super__ = titanium_reindeer.Scene;
star_control.StarControlScene.prototype = $extend(titanium_reindeer.Scene.prototype,{
	getImage: function(filePath) {
		return titanium_reindeer.Scene.prototype.getImage.call(this,"img/" + filePath);
	}
	,__class__: star_control.StarControlScene
});
...
star_control.BattleScene = $hxClasses["star_control.BattleScene"] = function(game) {
	star_control.StarControlScene.call(this,game,"battleScene",0,7,titanium_reindeer.Color.getBlackConst());
	this.starControlGame = game;
	this.player1Score = 0;
	this.player2Score = 0;
	this.ui = new star_control.UiBar(this,new titanium_reindeer.Vector2(600,0));
	var ship1 = new star_control.Fighter(this,new titanium_reindeer.Color(0,162,232),this.ui.ship1Ui);
	...
	var ship2 = new star_control.Artillery(this,new titanium_reindeer.Color(193,29,37),this.ui.ship2Ui);
	...
	this.inputManager.registerKeyEvent(titanium_reindeer.Key.Space,titanium_reindeer.KeyState.Down,this.pauseButton.$bind(this));
};
star_control.BattleScene.__name__ = ["star_control","BattleScene"];
star_control.BattleScene.__super__ = star_control.StarControlScene;
star_control.BattleScene.prototype = $extend(star_control.StarControlScene.prototype,{
	starControlGame: null
	,player1: null
	,player2: null
	,ui: null
	,player1Score: null
	,player2Score: null
	,notifyShipDied: function(player) {
	...
	,__class__: star_control.BattleScene
});
star_control.CollisionGroups = $hxClasses["star_control.CollisionGroups"] = function() { }
star_control.CollisionGroups.__name__ = ["star_control","CollisionGroups"];
star_control.CollisionGroups.prototype = {
	__class__: star_control.CollisionGroups
}
star_control.Direction = $hxClasses["star_control.Direction"] = { __ename__ : ["star_control","Direction"], __constructs__ : ["Right","Left"] }
...
star_control.Fighter = $hxClasses["star_control.Fighter"] = function(scene,highlight,shipUi) {
	star_control.Ship.call(this,scene,highlight,"fighter.png",shipUi,10,14,600,50,2,Math.PI,400,250);
	this.fireSounds = new titanium_reindeer.SoundGroup(this.getManager().soundManager,10);
	this.fireSounds.addSound("fire",this.getManager().getSound("sound/fighter_fire.mp3"));
};
star_control.Fighter.__name__ = ["star_control","Fighter"];
star_control.Fighter.__super__ = star_control.Ship;
star_control.Fighter.prototype = $extend(star_control.Ship.prototype,{
	fireSounds: null
	,shoot: function(msTimeStep) {
	...
	,__class__: star_control.Fighter
});
star_control.FighterBullet = $hxClasses["star_control.FighterBullet"] = function(owner) {
...
star_control.FighterBullet.prototype = $extend(star_control.Projectile.prototype,{
	__class__: star_control.FighterBullet
});
star_control.MenuScene = $hxClasses["star_control.MenuScene"] = function(game) {
	star_control.StarControlScene.call(this,game,"menuScene",1,3,titanium_reindeer.Color.getClearConst());
	this.starControlGame = game;
	...
	this.resumeButton.registerMouseClickEvent(this.resumeClick.$bind(this));
};
star_control.MenuScene.__name__ = ["star_control","MenuScene"];
star_control.MenuScene.__super__ = star_control.StarControlScene;
star_control.MenuScene.prototype = $extend(star_control.StarControlScene.prototype,{
	starControlGame: null
	,menuBackground: null
	,resumeButton: null
	,resumeClick: function(mousePos) {
	...
	,destroy: function() {
		...
		star_control.StarControlScene.prototype.destroy.call(this);
	}
	,__class__: star_control.MenuScene
});
star_control.Player = $hxClasses["star_control.Player"] = function(scene,ship,thrustKey,turnRightKey,turnLeftKey,shootKey) {
	titanium_reindeer.GameObject.call(this,scene);
	...
	this.getManager().getGame().inputManager.registerKeyEvent(thrustKey,titanium_reindeer.KeyState.Down,this.thrustDown.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(thrustKey,titanium_reindeer.KeyState.Up,this.thrustUp.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(turnRightKey,titanium_reindeer.KeyState.Down,this.rightDown.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(turnRightKey,titanium_reindeer.KeyState.Up,this.rightUp.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(turnLeftKey,titanium_reindeer.KeyState.Down,this.leftDown.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(turnLeftKey,titanium_reindeer.KeyState.Up,this.leftUp.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(shootKey,titanium_reindeer.KeyState.Down,this.shootDown.$bind(this));
	this.getManager().getGame().inputManager.registerKeyEvent(shootKey,titanium_reindeer.KeyState.Up,this.shootUp.$bind(this));
};
star_control.Player.__name__ = ["star_control","Player"];
star_control.Player.__super__ = titanium_reindeer.GameObject;
star_control.Player.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	battleScene: null
	,ship: null
	,isThrusting: null
	,isTurningRight: null
	...
	,update: function(msTimeStep) {
		if(this.ship.health <= 0) this.battleScene.notifyShipDied(this);
	...
	,__class__: star_control.Player
});
star_control.ShipUi = $hxClasses["star_control.ShipUi"] = function(scene) {
	titanium_reindeer.GameObject.call(this,scene);
...
star_control.ShipUi.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	background: null
	,healthBars: null
	,ammoBars: null
	,maxHealth: null
	...
	,lastHealth: null
	,lastAmmo: null
	,initialize: function(maxHealth,maxAmmo) {
		...
		while(_g1 < _g) {
			...
			if(i > 9) x += 16;
			var y = 4 + i % 10 * 8;
			healthBar.setOffset(new titanium_reindeer.Vector2(-30. + x,-40. + y));
		...
		while(_g1 < _g) {
			...
			if(i > 9) x += 16;
			var y = 4 + i % 10 * 8;
			ammoBar.setOffset(new titanium_reindeer.Vector2(-30. + x,-40. + y));
...
star_control.StarControlGame = $hxClasses["star_control.StarControlGame"] = function() {
...
star_control.StarControlGame.prototype = $extend(titanium_reindeer.Game.prototype,{
	battleScene: null
	,menuScene: null
	,startMenu: function() {
	...
	,__class__: star_control.StarControlGame
});
star_control.UiBar = $hxClasses["star_control.UiBar"] = function(scene,pos) {
	titanium_reindeer.GameObject.call(this,scene);
	this.setPosition(pos.add(new titanium_reindeer.Vector2(50.,300.)));
	...
	this.p1Title.setOffset(new titanium_reindeer.Vector2(0,-220.));
	...
	this.p2Title.setOffset(new titanium_reindeer.Vector2(0,94.));
	...
	this.divideLine.setOffset(new titanium_reindeer.Vector2(-50.,0));
	...
	this.ship1Ui.setPosition(pos.add(new titanium_reindeer.Vector2(36. + shipUiMargin,143.)));
	this.ship2Ui = new star_control.ShipUi(this.getManager());
	this.ship2Ui.setPosition(pos.add(new titanium_reindeer.Vector2(36. + shipUiMargin,457.)));
};
star_control.UiBar.__name__ = ["star_control","UiBar"];
star_control.UiBar.__super__ = titanium_reindeer.GameObject;
star_control.UiBar.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	background: null
	,p1Title: null
	,p2Title: null
	,p1Score: null
	...
	,ship1Ui: null
	,ship2Ui: null
	,updateScore: function(p1Score,p2Score) {
		this.p1Score.setText(p1Score + "");
		this.p2Score.setText(p2Score + "");
	}
	,__class__: star_control.UiBar
});
...
titanium_reindeer.LineRenderer = $hxClasses["titanium_reindeer.LineRenderer"] = function(endPoint,layer) {
	...
	this.watchedEndPoint = new titanium_reindeer.WatchedVector2(endPoint.getX(),endPoint.getY(),this.endPointChanged.$bind(this));
...
titanium_reindeer.LineRenderer.prototype = $extend(titanium_reindeer.StrokeFillRenderer.prototype,{
	...
	,__class__: titanium_reindeer.LineRenderer
	,__properties__: $extend(titanium_reindeer.StrokeFillRenderer.prototype.__properties__,{set_endPoint:"setEndPoint",get_endPoint:"getEndPoint"})
});
...
titanium_reindeer.ui.Button = $hxClasses["titanium_reindeer.ui.Button"] = function(scene,fgLayer,collision) {
	titanium_reindeer.GameObject.call(this,scene);
	this.setText("");
	...
	this.mouseHandler.registerMouseMoveEvent(titanium_reindeer.MouseRegionMoveEvent.Enter,this.mouseEnter.$bind(this));
	this.mouseHandler.registerMouseMoveEvent(titanium_reindeer.MouseRegionMoveEvent.Exit,this.mouseExit.$bind(this));
	this.mouseHandler.registerMouseButtonEvent(titanium_reindeer.MouseRegionButtonEvent.Down,this.mouseDown.$bind(this));
	this.mouseHandler.registerMouseButtonEvent(titanium_reindeer.MouseRegionButtonEvent.Up,this.mouseUp.$bind(this));
	this.getManager().inputManager.registerMouseButtonEvent(titanium_reindeer.MouseButton.Left,titanium_reindeer.MouseButtonState.Up,this.mouseUpGlobal.$bind(this));
};
...
titanium_reindeer.ui.Button.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	shownText: null
	,text: null
	,setText: function(value) {
		if(value != this.text) {
	...
	,setVisible: function(value) {
		if(value != this.visible) {
			this.visible = value;
			if(this.visible) this.appear(); else this.disappear();
		}
		return this.visible;
	}
	,registerMouseClickEvent: function(func) {
		if(func == null) return;
		this.registeredMouseClickEvents.push(func);
	}
	,enable: function() {
	...
	,mouseExit: function(mousePos) {
		if(this.isMouseOver && this.enabled) {
			this.isMouseOver = false;
			this.mouseOverStop();
		}
	}
	,mouseDown: function(mousePos,button) {
		if(button == titanium_reindeer.MouseButton.Left && !this.isHeldDown && this.enabled) {
			this.isHeldDown = true;
			this.heldDownStart();
		}
	}
	,mouseUp: function(mousePos,button) {
		if(button == titanium_reindeer.MouseButton.Left && this.isHeldDown && this.enabled) {
			this.isHeldDown = false;
			this.heldDownStop();
			this.click(mousePos);
	...
	,mouseUpGlobal: function(mousePos) {
		if(this.isHeldDown && this.enabled) {
			this.isHeldDown = false;
			this.heldDownStop();
		}
	}
	,mouseOverStart: function() {
	}
	,mouseOverStop: function() {
	}
	,heldDownStart: function() {
	}
	,heldDownStop: function() {
	}
	...
	,destroy: function() {
		...
		if(this.mouseHandler != null) {
			this.mouseHandler.unregisterMouseMoveEvent(titanium_reindeer.MouseRegionMoveEvent.Enter,this.mouseEnter.$bind(this));
			this.mouseHandler.unregisterMouseMoveEvent(titanium_reindeer.MouseRegionMoveEvent.Exit,this.mouseExit.$bind(this));
			this.mouseHandler.unregisterMouseButtonEvent(titanium_reindeer.MouseRegionButtonEvent.Down,this.mouseDown.$bind(this));
			this.mouseHandler.unregisterMouseButtonEvent(titanium_reindeer.MouseRegionButtonEvent.Up,this.mouseUp.$bind(this));
			this.mouseHandler.destroy();
			this.mouseHandler = null;
		}
		if(this.getManager() != null) this.getManager().inputManager.unregisterMouseButtonEvent(titanium_reindeer.MouseButton.Left,titanium_reindeer.MouseButtonState.Up,this.mouseUpGlobal.$bind(this));
	}
	,__class__: titanium_reindeer.ui.Button
	,__properties__: $extend(titanium_reindeer.GameObject.prototype.__properties__,{set_visible:"setVisible",set_enabled:"setEnabled",set_text:"setText"})
});
titanium_reindeer.ui.RectButton = $hxClasses["titanium_reindeer.ui.RectButton"] = function(scene,width,height,bgLayer,fgLayer) {
...
titanium_reindeer.ui.RectButton.prototype = $extend(titanium_reindeer.ui.Button.prototype,{
	shownRect: null
	,collisionRect: null
	,width: null
	,setWidth: function(value) {
	...
	,__class__: titanium_reindeer.ui.RectButton
	,__properties__: $extend(titanium_reindeer.ui.Button.prototype.__properties__,{set_height:"setHeight",set_width:"setWidth"})
});
js.Boot.__res = {}
js.Boot.__init();
{
...
star_control.ShipUi.START_X = -36.;
star_control.ShipUi.START_Y = -43.;
