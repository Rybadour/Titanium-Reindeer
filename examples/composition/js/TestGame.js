...
CirclePortion = function(radius,startRads,endRads,layer) {
	if( radius === $_ ) return;
	titanium_reindeer.StrokeFillRenderer.call(this,radius * 2,radius * 2,layer);
	this.radius = radius;
...
CirclePortion.__name__ = ["CirclePortion"];
CirclePortion.__super__ = titanium_reindeer.StrokeFillRenderer;
for(var k in titanium_reindeer.StrokeFillRenderer.prototype ) CirclePortion.prototype[k] = titanium_reindeer.StrokeFillRenderer.prototype[k];
CirclePortion.prototype.radius = null;
CirclePortion.prototype.startRads = null;
CirclePortion.prototype.endRads = null;
CirclePortion.prototype.render = function() {
	titanium_reindeer.StrokeFillRenderer.prototype.render.call(this);
	this.getPen().beginPath();
	this.getPen().arc(0,0,this.radius,this.startRads,this.endRads);
	this.getPen().fill();
	this.getPen().closePath();
	if(this.lineWidth > 0) {
		this.getPen().beginPath();
		this.getPen().arc(0,0,this.radius - this.lineWidth / 2,this.startRads,this.endRads);
		this.getPen().stroke();
		this.getPen().closePath();
	}
}
CirclePortion.prototype.__class__ = CirclePortion;
...
titanium_reindeer.CompositionLayer = function(renderer,composition) {
...
Thing = function(p) {
	...
	this.body = new titanium_reindeer.CompositionRenderer([new titanium_reindeer.CompositionLayer(a),new titanium_reindeer.CompositionLayer(b,titanium_reindeer.Composition.DestinationOut)],1);
	this.addComponent("body",this.body);
	this.velo = new titanium_reindeer.MovementComponent(new titanium_reindeer.Vector2(0,8));
...
titanium_reindeer.CompositionRenderer = function(layers,layerNum) {
	if( layers === $_ ) return;
	this.layers = layers;
	this.maxWidth = 0;
	this.maxHeight = 0;
...
titanium_reindeer.CompositionRenderer.prototype.render = function() {
	...
	this.getPen().drawImage(this.compositionCanvas,-this.maxWidth / 2 - 1,-this.maxHeight / 2 - 1);
}
