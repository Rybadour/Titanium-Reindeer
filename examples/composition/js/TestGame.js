...
titanium_reindeer.RendererComponent.prototype.preRender = function() {
	this.getPen().save();
	this.getPen().globalCompositeOperation = titanium_reindeer.RendererComponent.CompositionToString(this.layer.renderComposition);
...
titanium_reindeer.Game = function(targetHtmlId,width,height,layerCount,debugMode,backgroundColor) { if( targetHtmlId === $_ ) return; {
	if(targetHtmlId == null || targetHtmlId == "") this.targetElement = js.Lib.document.createElement("div");
	else this.targetElement = js.Lib.document.getElementById(targetHtmlId);
...
TestGame = function(p) { if( p === $_ ) return; {
	titanium_reindeer.Game.call(this,"TestGame",800,500,2,true,new titanium_reindeer.Color(255,255,100));
...
titanium_reindeer.UnsaturateEffect = function(p) { if( p === $_ ) return; {
...
titanium_reindeer.CompositionLayer = function(renderer,composition) { if( renderer === $_ ) return; {
	this.renderer = renderer;
	this.renderComposition = composition == null?titanium_reindeer.Composition.SourceOver:composition;
}}
titanium_reindeer.CompositionLayer.__name__ = ["titanium_reindeer","CompositionLayer"];
titanium_reindeer.CompositionLayer.prototype.renderer = null;
titanium_reindeer.CompositionLayer.prototype.renderComposition = null;
titanium_reindeer.CompositionLayer.prototype.__class__ = titanium_reindeer.CompositionLayer;
...
titanium_reindeer.ComponentManager = function(gameObjectManager) { if( gameObjectManager === $_ ) return; {
...
titanium_reindeer.RendererComponentManager = function(gameObjectManager) { if( gameObjectManager === $_ ) return; {
...
titanium_reindeer.GameObject = function(p) { if( p === $_ ) return; {
	titanium_reindeer.ManagedObject.call(this);
...
titanium_reindeer.GameObject.prototype.getManager = function() {
	if(this.manager == null) return null;
		...
		var $r;
		var $t = $this.manager;
		if(Std["is"]($t,titanium_reindeer.GameObjectManager)) $t;
		else throw "Class cast error";
		$r = $t;
		return $r;
	}(this));
...
Thing = function(p) { if( p === $_ ) return; {
	titanium_reindeer.GameObject.call(this);
	this.body = new titanium_reindeer.CompositionRenderer([new titanium_reindeer.CompositionLayer(new titanium_reindeer.RectRenderer(40,40,0)),new titanium_reindeer.CompositionLayer(new titanium_reindeer.CircleRenderer(20,0),titanium_reindeer.Composition.DestinationOut)],1);
	this.addComponent("body",this.body);
	this.velo = new titanium_reindeer.MovementComponent(new titanium_reindeer.Vector2(5,0));
	this.addComponent("velo",this.velo);
}}
Thing.__name__ = ["Thing"];
Thing.__super__ = titanium_reindeer.GameObject;
for(var k in titanium_reindeer.GameObject.prototype ) Thing.prototype[k] = titanium_reindeer.GameObject.prototype[k];
Thing.prototype.body = null;
Thing.prototype.velo = null;
...
titanium_reindeer.CompositionRenderer = function(layers,layerNum) { if( layers === $_ ) return; {
	this.layers = layers;
	this.maxWidth = 0;
	this.maxHeight = 0;
	{
		...
		while(_g < _g1.length) {
			var layer = _g1[_g];
			++_g;
			if(layer.renderer.drawnWidth > this.maxWidth) this.maxWidth = layer.renderer.drawnWidth;
			if(layer.renderer.drawnHeight > this.maxHeight) this.maxHeight = layer.renderer.drawnHeight;
		}
	}
	titanium_reindeer.RendererComponent.call(this,this.maxWidth,this.maxHeight,layerNum);
...
titanium_reindeer.CompositionRenderer.__name__ = ["titanium_reindeer","CompositionRenderer"];
titanium_reindeer.CompositionRenderer.__super__ = titanium_reindeer.RendererComponent;
for(var k in titanium_reindeer.RendererComponent.prototype ) titanium_reindeer.CompositionRenderer.prototype[k] = titanium_reindeer.RendererComponent.prototype[k];
titanium_reindeer.CompositionRenderer.prototype.compositionCanvas = null;
titanium_reindeer.CompositionRenderer.prototype.compositionPen = null;
titanium_reindeer.CompositionRenderer.prototype.layers = null;
titanium_reindeer.CompositionRenderer.prototype.maxWidth = null;
titanium_reindeer.CompositionRenderer.prototype.maxHeight = null;
titanium_reindeer.CompositionRenderer.prototype.initialize = function() {
	null;
}
titanium_reindeer.CompositionRenderer.prototype.preRender = function() {
	titanium_reindeer.RendererComponent.prototype.preRender.call(this);
	{
		var _g = 0, _g1 = this.layers;
		while(_g < _g1.length) {
			var layer = _g1[_g];
			++_g;
			layer.renderer.useAlternateCanvas(this.compositionPen,new titanium_reindeer.Vector2(this.maxWidth / 2 + 1,this.maxHeight / 2 + 1));
		}
	}
}
titanium_reindeer.CompositionRenderer.prototype.render = function() {
	titanium_reindeer.RendererComponent.prototype.render.call(this);
	{
		...
		while(_g < _g1.length) {
			var layer = _g1[_g];
			++_g;
			this.compositionPen.globalCompositeOperation = titanium_reindeer.RendererComponent.CompositionToString(layer.renderComposition);
			layer.renderer.preRender();
			layer.renderer.render();
			layer.renderer.postRender();
		}
	}
	this.getPen().drawImage(this.compositionCanvas,0,0);
}
titanium_reindeer.CompositionRenderer.prototype.postRender = function() {
	{
		var _g = 0, _g1 = this.layers;
		while(_g < _g1.length) {
			var layer = _g1[_g];
	...
	titanium_reindeer.RendererComponent.prototype.postRender.call(this);
}
titanium_reindeer.CompositionRenderer.prototype.__class__ = titanium_reindeer.CompositionRenderer;
...
titanium_reindeer.GameObjectManager = function(game) { if( game === $_ ) return; {
	titanium_reindeer.ObjectManager.call(this);
	this.game = game;
...
titanium_reindeer.CollisionComponentManager = function(gameObjectManager) { if( gameObjectManager === $_ ) return; {
	titanium_reindeer.ComponentManager.call(this,gameObjectManager);
...
titanium_reindeer.MovementComponentManager = function(gameObjectManager) { if( gameObjectManager === $_ ) return; {
	titanium_reindeer.ComponentManager.call(this,gameObjectManager);
}}
...
titanium_reindeer.PixelatedEffect = function(amount) { if( amount === $_ ) return; {
	titanium_reindeer.BitmapEffect.call(this);
	this.amount = amount;
}}
...
titanium_reindeer.RenderLayerManager = function(numLayers,targetElement,backgroundColor,gameWidth,gameHeight) { if( numLayers === $_ ) return; {
	...
	this.layers = new Array();
	{
		...
		while(_g < numLayers) {
			var i = _g++;
			if(i == 0) this.layers.push(new titanium_reindeer.RenderLayer(this,i,targetElement,gameWidth,gameHeight,backgroundColor));
