...
var CirclePortion = $hxClasses["CirclePortion"] = function(radius,startRads,endRads,layer) {
...
CirclePortion.prototype = $extend(titanium_reindeer.StrokeFillRenderer.prototype,{
	radius: null
	,startRads: null
	,endRads: null
	,render: function() {
...
var TestGame = $hxClasses["TestGame"] = function() {
	...
	this.globalScene = new titanium_reindeer.Scene(this,"globalScene",0,2,titanium_reindeer.Color.getBlackConst());
...
var Thing = $hxClasses["Thing"] = function(scene) {
...
Thing.prototype = $extend(titanium_reindeer.GameObject.prototype,{
	body: null
	,velo: null
	,__class__: Thing
});
...
titanium_reindeer.CompositionLayer = $hxClasses["titanium_reindeer.CompositionLayer"] = function(renderer,composition) {
...
titanium_reindeer.CompositionLayer.prototype = {
	renderer: null
	,renderComposition: null
	,__class__: titanium_reindeer.CompositionLayer
}
titanium_reindeer.CompositionRenderer = $hxClasses["titanium_reindeer.CompositionRenderer"] = function(layers,layerNum) {
	this.layers = layers;
	this.maxWidth = 0;
	this.maxHeight = 0;
...
titanium_reindeer.CompositionRenderer.prototype = $extend(titanium_reindeer.RendererComponent.prototype,{
	...
	,__class__: titanium_reindeer.CompositionRenderer
});
